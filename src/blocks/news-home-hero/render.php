...
if ( ! function_exists( __NAMESPACE__ . '\\nhh_get_section_posts' ) ) {
	...
	function nhh_render_story( $story, $show_image = false ) {
		...
		<article class="<?php echo esc_attr( $classes ); ?>">
			<?php if ( $has_image ) : ?>
				<figure class="news-home-hero__story-image" aria-hidden="true">
					<?php echo get_the_post_thumbnail( $story, 'medium_large' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
				</figure>
			<?php endif; ?>
			<h3 class="news-home-hero__story-title wp-block-heading heading-style--h6">
	...
	function nhh_render_featured_story( $category_id, $location_id ) {
		...
		<article class="news-home-hero__featured">
			<h2 class="news-home-hero__featured-title wp-block-heading heading-style--h1">
				<a href="<?php echo esc_url( $permalink ); ?>"><?php echo esc_html( get_the_title( $story ) ); ?></a>
			</h2>
			<?php if ( has_post_thumbnail( $story ) ) : ?>
				<figure class="news-home-hero__featured-image" aria-hidden="true">
			...
			<?php if ( $excerpt ) : ?>
				<div class="news-home-hero__featured-excerpt wp-block-post-excerpt">
...
$topics_heading_id = wp_unique_id( 'nhh-topics-heading-' );
		...
		<div class="news-home-hero__columns">
			...
			<div class="news-home-hero__column news-home-hero__column--left">
				...
				<div class="news-home-hero__area news-home-hero__area--topics">
					<nav class="news-home-hero__topics" aria-labelledby="<?php echo esc_attr( $topics_heading_id ); ?>">
						...
						<h3 id="<?php echo esc_attr( $topics_heading_id ); ?>" class="news-home-hero__heading utkwds-eyebrow">Topics</h3>
