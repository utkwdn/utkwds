...
<!-- wp:group {"className":"utkwds-horizontal-single-2up-group","layout":{"type":"constrained"},"metadata":{"name":"Horizontal 2up white"}} -->
<div class="wp-block-group utkwds-horizontal-single-2up-group">
	<!-- wp:heading -->
	<h2 class="wp-block-heading">Horizontal 2up white</h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-columns">
		...
		<div
			class="wp-block-column utkwds-horizontal-single has-white-background-color has-background"
		>
