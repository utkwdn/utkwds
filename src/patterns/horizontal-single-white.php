...
<div
	class="wp-block-group alignfull utkwds-horizontal-single has-light-background-color has-background"
	style="
	...
	"
>
	<!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"backgroundColor":"white","className":"utkwds-horizontal-single","layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"top"}} -->
	<div
		class="wp-block-group utkwds-horizontal-single has-white-background-color has-background"
	>
