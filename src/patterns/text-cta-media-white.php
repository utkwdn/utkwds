...
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|small","right":"var:preset|spacing|small","bottom":"var:preset|spacing|small","left":"var:preset|spacing|small"}}},"className":"utkwds-text-cta-media","layout":{"type":"constrained"},"metadata":{"name":"Text with CTA \u0026 media white"}} -->
