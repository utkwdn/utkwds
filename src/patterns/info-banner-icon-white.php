<?php
/**
 * Title: Info Banner Icon White
 * Slug: utkwds/info-banner-icon-white
 * Description: 
 * Categories: 
...
?>
<!-- wp:columns {"verticalAlignment":null,"className":"utkwds-info-banner-icon"} -->
<div class="wp-block-columns utkwds-info-banner-icon"><!-- wp:column {"verticalAlignment":"top","width":"30%"} -->
