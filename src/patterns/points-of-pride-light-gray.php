...
<div
	class="wp-block-group alignfull utkwds-points-of-pride has-light-background-color has-background"
	style="
...
>
	...
	<div class="wp-block-columns alignwide">
		...
		<div
			...
			style="padding-top: var( --wp--preset--spacing--small )"
		>
			...
			<!-- wp:paragraph -->
			<p>
				and <strong>small text</strong> can be used in any combo —
				choose what fits your content best.
			</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		>
			...
			<p>
				With the
				<a href="https://wordpress.org/documentation/article/list-view/"
					>List View toolbar</a
				>
				open, click the 3 dots beside the column whose styles you want
		...
		>
			...
			<!-- wp:paragraph -->
			<p>
				is the maximum number of characters you should use in the
				<strong>big text</strong> field. Try to reserve that for
	...
	<div class="wp-block-columns alignwide">
		...
		>
			...
			<!-- wp:paragraph -->
			<p>
				Delete any you don't need via the Column's 3-dots menu in the
				<a href="https://wordpress.org/documentation/article/list-view/"
					>List View</a
				>
				toolbar.
		...
		>
			...
			<!-- wp:paragraph -->
			<p>
				For <strong>small text</strong>, use no more than 15 to 20
				words. Sentence fragments are OK.
				<a href="#">Link to source data</a> where possible.
			</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		>
			...
			<!-- wp:paragraph -->
			<p>
				when you don't have a numeral or your stat is too long for the
				big text to fit on one line.
			</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
