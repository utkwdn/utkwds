 ...
 * Description: A full-width pattern with columns for displaying statistics and numeric points of pride. Use for 1 to 4 columns of stats, with a light gray background.
 * Categories: banners
...
<!-- wp:group {"metadata":{"name":"Points of Pride light gray"},"align":"full","style":{"spacing":{"margin":{"top":"var:preset|spacing|medium","bottom":"var:preset|spacing|medium"},"blockGap":"var:preset|spacing|medium","padding":{"right":"var:preset|spacing|small","left":"var:preset|spacing|small"}}},"backgroundColor":"light","className":"utkwds-points-of-pride","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull utkwds-points-of-pride has-light-background-color has-background" style="margin-top:var(--wp--preset--spacing--medium);margin-bottom:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--small);padding-left:var(--wp--preset--spacing--small)"><!-- wp:heading {"align":"wide"} -->
...
<!-- wp:paragraph -->
<p>With the <a href="https://wordpress.org/documentation/article/list-view/">List View toolbar</a> open, click the 3 dots beside the column whose styles you want and choose "Duplicate."</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph -->
<p>is the maximum number of characters you should use in the <strong>big text</strong> field. Try to reserve that for numerals and symbols.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:paragraph -->
<p>For <strong>small text</strong>, use no more than 15 to 20 words. Sentence fragments are OK. <a href="#">Link to source data</a> where possible.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph -->
<p>when you don't have a numeral or your stat is too long for the big text to fit on one line.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->