<?php
/**
 * Title: Info Banner Icon Smokey
 * Slug: utkwds/info-banner-icon-smokey
 * Description: 
 * Categories: 
...
?>
<!-- wp:columns {"verticalAlignment":null,"style":{"elements":{"link":{"color":{"text":"var:preset|color|white"}}}},"backgroundColor":"smokey","textColor":"white","className":"utkwds-info-banner-icon"} -->
<div class="wp-block-columns utkwds-info-banner-icon has-white-color has-smokey-background-color has-text-color has-background has-link-color"><!-- wp:column {"verticalAlignment":"top","width":"30%"} -->
<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:30%"><!-- wp:image {"align":"center","id":166,"sizeSlug":"full","linkDestination":"none"} -->
