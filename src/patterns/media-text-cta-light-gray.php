 ...
 * Categories: hero
 * Keywords: full-width, full width, hero, header, image, single image, video, media, text, CTA link, light gray
 * Viewport Width: 1500
 * Block Types:
 * Post Types:
 * Inserter: true
...
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|small","right":"var:preset|spacing|small","bottom":"var:preset|spacing|small","left":"var:preset|spacing|small"}}},"backgroundColor":"light","className":"utkwds-media-text-cta","layout":{"type":"constrained"},"metadata":{"name":"Media \u0026 text with CTA light gray"}} -->
<div
	class="wp-block-group alignfull utkwds-media-text-cta has-light-background-color has-background"
	style="
...
>
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column">
			...
			<!-- wp:paragraph -->
			<p>
				The Media & Text with CTA pattern is designed to fill the hero
