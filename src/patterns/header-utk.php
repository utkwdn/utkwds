...
<!-- wp:group {"className":"wp-block-group header-site-title universal-header__inner-blocks","layout":{"type":"default"}} -->
<div class="wp-block-group header-site-title universal-header__inner-blocks"><!-- wp:site-title {"level":0,"isLink":false,"style":{"typography":{"lineHeight":"1.2"}},"className": "header-site-title"} /--></div>
<!-- /wp:group -->
