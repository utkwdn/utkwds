...
>
	...
	<div class="wp-block-columns alignwide">
		<!-- wp:column {"width":"60%","style":{"elements":{"link":{"color":{"text":"var:preset|color|white"}}},"spacing":{"blockGap":"var:preset|spacing|small"}},"textColor":"white"} -->
		<div
		...
		<div class="wp-block-column" style="flex-basis: 40%">
			...
			<p class="has-white-color has-text-color has-link-color">
				<strong>Contact us for help</strong>
			</p>
			<!-- /wp:paragraph -->
