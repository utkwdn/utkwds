<?php
/**
 * Title: CTA & Category Listing
 * Slug: utkwds/cta-category-listing
 * Description: Dynamic feed highlighting three recent posts from a category, showing featured image, title, date of publication on a light gray backgorund.
...
<!-- wp:paragraph -->
<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut ultrices, magna non consectetur lacinia, nisl sapien ornare erat, id interdum justo massa nec dui.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:66%"><!-- wp:query {"queryId":1,"query":{"perPage":3,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"taxQuery":{"include":{"category":[835]}},"parents":[],"format":[]}} -->
