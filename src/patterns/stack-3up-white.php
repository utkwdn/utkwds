 ...
 * Description: Three cards side-by-side (3up), containing image with thin orange line divider up top, stacked on top of header, text information, and optional in-text links, on a white background.
 * Categories: content-cards
 * Keywords: card, 3up, image, white
 * Viewport Width: 1500
 * Block Types:
 * Post Types:
 * Inserter: true
...
<h2 class="wp-block-heading alignwide">Stack 3up white</h2>
<!-- /wp:heading -->
