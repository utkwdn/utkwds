...
<div class="wp-block-group header-site-title-wrapper universal-header__inner-blocks"><!-- wp:site-tagline {"className":"header-site-tagline"} /--><!-- wp:site-tagline /--><!-- wp:site-title {"level":0,"isLink":true,"style":{"typography":{"lineHeight":"1.2"}},"className": "header-site-title"} /--></div>
<!-- /wp:group -->
