<?php
/**
 * Title: Card Subject Group 2up White
 * Slug: utkwds/card-subject-group-2up-white
 * Description:
 * Categories: card
...
<div class="wp-block-group alignfull has-light-background-color has-background"><!-- wp:columns {"className":"utkwds-card-subject-2up-group"} -->
