...
<div class="wp-block-group utkwds-horizontal-single-2up-group">
	...
	<div class="wp-block-columns">
		...
		<div
			class="wp-block-column utkwds-horizontal-single has-white-color has-smokey-background-color has-text-color has-background has-link-color"
		>
			...
			<div class="wp-block-group">
				...
				>
					...
					<h3 class="wp-block-heading has-white-color has-text-color">
						Heading
					</h3>
					<!-- /wp:heading -->
