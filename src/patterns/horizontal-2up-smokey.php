...
<!-- wp:group {"className":"utkwds-horizontal-single-2up-group","layout":{"type":"constrained"},"metadata":{"name":"Horizontal 2up Smokey"}} -->
<div class="wp-block-group utkwds-horizontal-single-2up-group"><!-- wp:heading -->
<h2 class="wp-block-heading">Horizontal 2up Smokey</h2>
<!-- /wp:heading -->

<!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column {"style":{"elements":{"link":{"color":{"text":"var:preset|color|white"}}}},"backgroundColor":"smokey","textColor":"white","className":"utkwds-horizontal-single"} -->
<div class="wp-block-column utkwds-horizontal-single has-white-color has-smokey-background-color has-text-color has-background has-link-color"><!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left","verticalAlignment":"top"}} -->
...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--x-small);padding-right:0;padding-bottom:var(--wp--preset--spacing--x-small);padding-left:0"><!-- wp:heading {"level":3,"textColor":"white"} -->
...
<!-- wp:column {"style":{"elements":{"link":{"color":{"text":"var:preset|color|white"}}}},"backgroundColor":"smokey","textColor":"white","className":"utkwds-horizontal-single"} -->
<div class="wp-block-column utkwds-horizontal-single has-white-color has-smokey-background-color has-text-color has-background has-link-color"><!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left","verticalAlignment":"top"}} -->
<div class="wp-block-group"><!-- wp:image {"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/image-placeholder-small-square.png') );?>" alt="image placeholder" /></figure>
<!-- /wp:image -->
