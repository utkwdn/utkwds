...
<div class="wp-block-group alignfull utkwds-card-horizontal-full"><!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"backgroundColor":"white","className":"utkwds-card","layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"top"}} -->
<div class="wp-block-group utkwds-card has-white-background-color has-background"><!-- wp:image {"width":460,"sizeSlug":"full","linkDestination":"none"} -->
