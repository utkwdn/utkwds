 ...
 * Description: Large, formatted quote indicated by an orange quotation mark and large text. Quote block with image on white background.
 * Categories: quotes
 * Keywords: quote, image, white, 50/50, media
 * Viewport Width: 1500
 * Block Types:
 * Post Types:
 * Inserter: true
...
<div
	class="wp-block-media-text alignwide has-media-on-the-right is-stacked-on-mobile utkwds-media-quote has-white-background-color has-background"
>
