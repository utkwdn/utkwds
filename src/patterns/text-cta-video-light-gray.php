...
<div
	class="wp-block-group alignfull utkwds-text-cta-media has-light-background-color has-background"
	style="
...
>
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column">
			...
			<!-- wp:paragraph -->
			<p>
				The Text with CTA & video pattern is designed to fill the hero
		...
		<!-- wp:column -->
		<div class="wp-block-column">
			<!-- wp:embed {"providerNameSlug":"youtube","responsive":true,"className":"is-style-utkwds-right-frame wp-embed-aspect-16-9 wp-has-aspect-ratio"} /-->
		</div>
		<!-- /wp:column -->
	</div>
	<!-- /wp:columns -->
