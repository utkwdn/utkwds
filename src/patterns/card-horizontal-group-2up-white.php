<?php
/**
 * Title: Card Horizontal Group 2up White
 * Slug: utkwds/card-horizontal-group-2up-white
 * Description:
...
<!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column {"backgroundColor":"white","className":"utkwds-card-horizontal"} -->
<div class="wp-block-column utkwds-card-horizontal has-white-background-color has-background"><!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left","verticalAlignment":"top"}} -->
...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--50);padding-right:0;padding-bottom:var(--wp--preset--spacing--50);padding-left:0"><!-- wp:heading {"level":3,"fontSize":"medium"} -->
...
<!-- wp:column {"backgroundColor":"white","className":"utkwds-card-horizontal"} -->
<div class="wp-block-column utkwds-card-horizontal has-white-background-color has-background"><!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left","verticalAlignment":"top"}} -->
<div class="wp-block-group"><!-- wp:image {"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img alt="" /></figure>
<!-- /wp:image -->
