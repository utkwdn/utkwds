...
<div
	class="wp-block-group alignfull utkwds-icon-text has-light-background-color has-background"
	style="
	...
	<div class="wp-block-columns">
		...
		>
			...
			<div class="wp-block-utk-wds-icon-block items-justified-center">
				<div class="icon-container" style="width: 125px">
					<svg
						width="126"
						height="125"
						viewBox="0 0 126 125"
