...
<!-- wp:paragraph -->
<p>Make a message stand out on a page of details, so deadlines and special instructions don’t get lost in a wall of text. Only use once per page, remove it once its date passes, and aim not to leave up for more than a month, to avoid causing <a href="https://www.nngroup.com/articles/banner-blindness-old-and-new-findings/">banner blindness</a> for your site users.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
