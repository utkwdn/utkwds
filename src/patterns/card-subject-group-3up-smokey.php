<?php
/**
 * Title: Card Subject Group 3up Smokey
 * Slug: utkwds/card-subject-group-3up-smokey
 * Description:
 * Categories: card
...
<!-- wp:heading {"level":3,"style":{"spacing":{"padding":{"top":"0","right":"var:preset|spacing|40","bottom":"0","left":"var:preset|spacing|40"}},"elements":{"link":{"color":{"text":"var:preset|color|white"}}}},"textColor":"white","fontSize":"medium"} -->
<h3 class="wp-block-heading has-white-color has-text-color has-link-color has-medium-font-size" style="padding-top:0;padding-right:var(--wp--preset--spacing--40);padding-bottom:0;padding-left:var(--wp--preset--spacing--40)"></h3>
<!-- /wp:heading --></div>
<!-- /wp:group -->
</div>
<!-- /wp:column -->
