...
<div class="wp-block-group alignfull utkwds-full-width-hero">
	...
	<div
		class="wp-block-cover alignfull has-custom-content-position is-position-bottom-center"
	...
	>
		...
		><img
			...
			src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/repeat-placeholder-1700x700.jpg"
			alt="Repeat Placeholder"
			data-object-fit="cover"
		/>
		<div class="wp-block-cover__inner-container">
			<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|medium","bottom":"var:preset|spacing|medium","left":"var:preset|spacing|medium","right":"var:preset|spacing|medium"},"blockGap":"var:preset|spacing|small"}},"backgroundColor":"white","textColor":"smokey","layout":{"type":"constrained"}} -->
			<div
				class="wp-block-group has-smokey-color has-white-background-color has-text-color has-background"
				style="
			...
			>
				...
				<div class="wp-block-group">
					...
					<p
						class="utkwds-superhead has-condensed-font-family has-medium-font-size"
						style="
							font-style: italic;
							font-weight: 400;
							line-height: 1.1;
				...
				<!-- wp:paragraph -->
				<p>
					Paragraph 25 words or fewer. Use to orient users or unblock
					any barriers that would keep them from clicking a CTA link.
				</p>
				<!-- /wp:paragraph -->

				<!-- wp:paragraph {"className":"is-style-utkwds-cta-link"} -->
				<p class="is-style-utkwds-cta-link">
					<a href="https://www.utk.edu/">Optional CTA Link</a>
				</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
