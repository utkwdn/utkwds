 ...
 * Slug: utkwds/footer-three-columns-contrast-background
 * Categories: footer
...
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Privacy Policy', 'utkwds' ); ?></a> · <a href="#"><?php echo esc_html__( 'Terms of Service', 'utkwds' ); ?></a> · <a href="#"><?php echo esc_html__( 'Contact Us', 'utkwds' ); ?></a></p>
<!-- /wp:paragraph -->
