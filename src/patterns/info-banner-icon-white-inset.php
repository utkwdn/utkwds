<?php
/**
 * Title: Info Banner Icon White Inset
 * Slug: utkwds/info-banner-icon-white-inset
 * Description: 
 * Categories: content
...
<!-- wp:group {"align":"full","className":"utkwds-info-banner-icon","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull utkwds-info-banner-icon"><!-- wp:columns {"style":{"spacing":{"padding":{"top":"var:preset|spacing|60","right":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|60"}}},"backgroundColor":"white"} -->
<div class="wp-block-columns has-white-background-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60)"><!-- wp:column {"verticalAlignment":"top","width":"30%"} -->
