...
<div class="wp-block-group alignfull utkwds-icon-cta-card-3up has-light-background-color has-background"><!-- wp:columns {"align":"wide"} -->
<div class="wp-block-columns alignwide"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:group {"className":"utkwds-icon-cta-card-3up-content","style":{"spacing":{"blockGap":"var:preset|spacing|x-small"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group utkwds-icon-cta-card-3up-content"><!-- wp:utk-wds/icon-block {"iconName":"wds-torch"} -->
