<?php
/**
 * Title: Icon & text Smokey
 * Slug: utkwds/icon-text-smokey
 * Description: 
 * Categories: banners
...
?>
<!-- wp:group {"align":"full","style":{"elements":{"link":{"color":{"text":"var:preset|color|white"}}},"spacing":{"padding":{"top":"var:preset|spacing|60","right":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|60"}}},"backgroundColor":"smokey","textColor":"white","className":"utkwds-icon-text","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull utkwds-icon-text has-white-color has-smokey-background-color has-text-color has-background has-link-color" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60)"><!-- wp:columns -->
