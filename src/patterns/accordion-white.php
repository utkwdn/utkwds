...
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|small","bottom":"var:preset|spacing|small"}}},"className":"utkwds-accordion-group","layout":{"type":"constrained"},"metadata":{"name":"Accordion white"}} -->
<div class="wp-block-group alignfull utkwds-accordion-group" style="padding-top:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--small)"><!-- wp:utk-wds/accordion -->
...
<div class="wp-block-utk-wds-accordion-panel"><h2 class="utk-wds-accordion__heading" data-accordion-heading="true"><div>Accordion white</div></h2><section data-accordion-section="true"><div class="utk-wds-accordion__panel-body"><!-- wp:paragraph -->
