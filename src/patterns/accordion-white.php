...
<div
	class="wp-block-group alignfull utkwds-accordion-group"
	style="
...
>
	...
	<div class="wp-block-utk-wds-accordion">
		<div
			data-accordion="true"
			class="utk-wds-accordion-wrapper"
			data-color-scheme="light"
		>
			<!-- wp:utk-wds/accordion-panel -->
			<div class="wp-block-utk-wds-accordion-panel">
				<h2
					class="utk-wds-accordion__heading"
					data-accordion-heading="true"
				>
					<div>Accordion white</div>
				</h2>
				<section data-accordion-section="true">
					<div class="utk-wds-accordion__panel-body">
						<!-- wp:paragraph -->
						<p>
