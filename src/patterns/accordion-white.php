...
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60"}}},"className":"utkwds-accordion-group","layout":{"type":"constrained"},"metadata":{"name":"Accordion white"}} -->
<div class="wp-block-group alignfull utkwds-accordion-group" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)"><!-- wp:utk-wds/accordion -->
