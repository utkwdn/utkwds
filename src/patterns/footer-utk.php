...
>
	...
	<div class="wp-block-utk-wds-site-footer-info-panel">
		<a href="https://www.utk.edu/"
			><img
				src="<?php echo get_stylesheet_directory_uri(); ?>/assets/svg/utk-logo-white.svg"
		...
		<div class="wp-block-columns">
			...
			<div class="wp-block-column">
				...
				>
					...
					<!-- wp:paragraph -->
					<p>
						<?php echo wp_kses_post( get_theme_mod( 'address' ) ); ?>
					</p>
					<!-- /wp:paragraph -->
					...
					<?php endif; ?>
					<?php
					if ( get_theme_mod( 'phone_number_1' )
					&& get_theme_mod( 'phone_label_1' ) ) :
						?>
					<!-- wp:paragraph -->
					<p>
						...
						><br />
								...
								<?php
								if ( get_theme_mod( 'phone_number_2' ) &&
									get_theme_mod( 'phone_label_2' ) ) :
									?>
									<?php
									echo esc_html( get_theme_mod( 'phone_label_2' ) );
									?>
						:
						<a
			...
			<?php
			$locations = get_nav_menu_locations(); if ( isset(
				$locations['footer']
			) && $locations['footer'] ) {
				$footer_menu =
				wp_get_nav_menu_object( $locations['footer'] ); } else {
				$footer_menu = null; }
				?>
			...
			<div class="wp-block-column" style="flex-basis: 33%">
				...
				<h3
					class="wp-block-heading has-white-color has-text-color has-link-color has-normal-font-size"
				>
						<?php echo $footer_menu->name; ?>
				</h3>
				<!-- /wp:heading -->
