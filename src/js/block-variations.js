...
registerBlockVariation( 'core/paragraph', {
	...
	title: 'CTA Link',
	description:
		'A call to action is something you want a user to do (versus somewhere you want them to go). Function as a supporting button, taking the user down a task-path that leads to an interaction.',
	keywords: [
		__( 'call to action' ),
		__( 'button' ),
		__( 'cta' ),
...
registerBlockVariation( 'core/paragraph', {
	...
	title: 'Single Link',
	description:
		'For medium emphasis, like at the end of a paragraph. Limit to 30 characters to keep it "clickable."',
	keywords: [
		__( 'link' ),
		__( 'links' ),
		__( 'single' ),
