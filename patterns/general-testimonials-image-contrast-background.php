 ...
 * Slug: utkwds/general-testimonials-image-contrast-background
...
<p style="margin-top:0"><?php echo esc_html__( 'With its clean, minimal design and powerful features, utkwds enables agencies to build cool websites.', 'utkwds' ); ?></p>
<!-- /wp:paragraph -->
