 ...
 * @type {string[]}
 */
const ALLOWED_BLOCKS = ['utk-wds/accordion-panel'];
...
function Edit(props) {
  ...
  const ACCORDION_TEMPLATE = [['utk-wds/accordion-panel']];
  ...
  const onChangeColorScheme = newColorScheme => {
    setAttributes({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.InspectorControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
    ...
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Changes the heading level of all panel headings. Use `Heading 3` if the accordion comes after a level 2 heading.'),
    options: [{
      value: 'h2',
      label: 'Heading 2'
    }, {
    ...
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Use this setting to change the colors of the accordion so that they work against different background colors. Changing this setting does not change the background color.'),
    options: [{
      value: 'light',
...
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/accordion/edit.tsx");
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"utk-wds/accordion","version":"0.1.0","title":"Accordion","selectors":{"root":".wp-block-utk-wds-accordion"},"category":"theme","icon":"list-view","description":"A collection of panels that can be collapsed or opened with a click.","attributes":{"colorScheme":{"type":"string","default":"light"},"headingLevel":{"type":"string","default":"h2"}},"providesContext":{"utk-wds-accordion/headingLevel":"headingLevel"},"textdomain":"utk-wds","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","viewScript":["file:./accordion.ts"]}');
